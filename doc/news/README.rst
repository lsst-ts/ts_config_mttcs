...
An example file name would therefore look like ``OSW-1234.doc.rst``.
...
You can test how the content will be integrated into the release notes by running ``towncrier build --draft --version=v<X.Y.Z>``.
Note that you have to run it from the root repository directory (i.e. the ``ts_config_mttcs``).
